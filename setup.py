...
setuptools.setup(
    ...
    options={
        "app": {"formal_name": "eyegrade", "bundle": "org.eyegrade"},
        # Desktop/laptop deployments
        "macos": {"app_requires": requirements},
        "linux": {"app_requires": requirements},
        "windows": {"app_requires": requirements, "icon": "eyegrade/data/eyegrade"},
    },
    entry_points={
